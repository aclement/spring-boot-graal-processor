...
//		
		...
		options.add("-source");
		options.add("1.8");
		options.add("-Aorg.springframework.boot.reflectiveaccessannotationprocessor.classpath="+
				dependencies.stream().map(f -> f.toString()).collect( Collectors.joining( ":" ) ));
		options.add("-processor");
		options.add("org.springframework.boot.reflectionprocessor.ReflectiveAccessAnnotationProcessor");
